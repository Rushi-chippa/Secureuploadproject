    ...
    return (
        <div className="salesman-dashboard">
            <header className="page-header">
                ...
                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap' }}>
                    <select
                        ...
                        className="px-4 py-2 border border-gray-200 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-800 shadow-sm font-medium text-slate-700 dark:text-slate-200 cursor-pointer focus:ring-2 focus:ring-blue-500 outline-none"
                    >
                        {monthOptions.map(m => (
            ...
            <div className="product-overview-section" style={{ marginTop: '2rem' }}>
                <h2 className="text-[1.5rem] font-bold mb-4 text-slate-800 dark:text-slate-100">Available Products</h2>
                <div className="products-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(min(100%, 280px), 1fr))', gap: '1.5rem' }}>
                            ...
                            <div key={product.id} className="product-card" style={{
                                ...
                                <div>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '0.5rem', flexWrap: 'wrap', gap: '0.5rem' }}>
                                        <h3 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#0f172a', margin: 0, wordBreak: 'break-word', flex: 1 }}>{product.name}</h3>
                                        <span style={{
